import { IUserProfile, IUserProfileActionTypes, utcNowString } from 'awayto/core';
...

  {
    ...
    cmnd: async (props) => {
      try {
        ...
        console.log('IN PUT USER PROFILE WITH PROPS', { id, first_name, last_name, email, image } )
