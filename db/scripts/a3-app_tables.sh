...
\ c sysmaindb CREATE TABLE budgets (
...
CREATE TABLE uuid_service_addons (
  id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
  parent_uuid uuid NOT NULL,
