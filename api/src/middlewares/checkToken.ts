...
import { DecodedJWTToken, IGroup, RedisProxy, StrategyUser, UserGroupRoles, nid } from 'awayto/core';
import { IDatabase } from 'pg-promise';

export function checkToken(dbClient: IDatabase<unknown>, redisProxy: RedisProxy) {
