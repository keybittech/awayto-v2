...
import { IGroup, IUtilActionTypes, IGroupActionTypes, IAssistActionTypes, IRole, IPrompts } from 'awayto';
...
export function ManageGroupModal({ editGroup, closeModal, ...props }: IProps): JSX.Element {
  ...
  }, [group, roles, roleIds, defaultRoleId]);
  ...
  if (!roleIds.length && group.roles?.size && !defaultRoleId) {
