...
import { UseQueryStateOptions, UseMutationStateOptions, MutationTrigger, LazyQueryTrigger, UseLazyQueryLastPromiseInfo } from '@reduxjs/toolkit/dist/query/react/buildHooks';

import { AnyRecord, EndpointType, RemoveNever, ReplaceVoid, siteApiRef, SiteApiRef, utilConfig } from 'awayto/core';
...
type CustomUseQuery<D extends QueryDefinition<QueryArgFrom<D>, SiteBaseEndpoint, 'Root', ResultTypeFrom<D>, 'api'>> = (
  ...
  options?: (SubscriptionOptions & UseQueryStateOptions<D, AnyRecord>) | undefined
...
type CustomUseMutation<D extends MutationDefinition<QueryArgFrom<D>, SiteBaseEndpoint, 'Root', ResultTypeFrom<D>, 'api'>> = (
  arg: QueryArgFrom<D> | SkipToken,
  options?: (SubscriptionOptions & UseMutationStateOptions<D, AnyRecord>) | undefined
) => [
  MutationTrigger<D>, 
